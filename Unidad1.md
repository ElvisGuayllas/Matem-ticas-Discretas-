...
- Conjunción (∧) &🟰: es verdadera si ambas proposiciones son verdaderas.  
- Disyunción (∨) 🔀: es verdadera si al menos una de las proposiciones es verdadera.  
- Condicional (→) ➡️: es falsa solo cuando la primera proposición es verdadera y la segunda es falsa.  
- Bicondicional (↔) ⬄: es verdadera cuando ambas proposiciones tienen el mismo valor de verdad.  

Estos operadores permiten construir fórmulas complejas y analizar su validez mediante reglas y tablas de verdad​.

**1.2 TABLAS DE VERDAD.** 📊✔️❌  
Una tabla de verdad es un dispositivo gráfico o tabla que muestra todos los posibles valores de verdad de una proposición compuesta según las diferentes combinaciones de valores de verdad (verdadero o falso) de las proposiciones simples que la forman. Permite visualizar cómo varía el valor de verdad de la proposición compuesta con respecto a las variaciones en las proposiciones básicas.
...
[ACD1: LOGICA PROPOCICIONAL, CONECTORES Y TABLAS DE VERDAD](https://drive.google.com/file/d/1R8W6KhsKb1eTCWCCe3TwuBt_1p5Higud/view?usp=drive_link)  
[ACD2: implicaciones, equivalencias y razonamiento deductivo (leyes proposicionales y reglas de inferencia)](https://drive.google.com/file/d/1e-gW32WLRcJE9hjNn2x9GBarnN3XL9aj/view?usp=drive_link)  

**AA (Aprendizaje autónomo)**  
[AA. LECTURA Y EJERCICIOS](https://drive.google.com/file/d/1pauIOkp8B52OgquhouCWOxsnlHK5bWuE/view?usp=drive_link)
